...
tf.flags.DEFINE_integer('image_size1', 128, 'image size, default: 256')
tf.flags.DEFINE_integer('image_size2', 128, 'image size, default: 256')
...
tf.flags.DEFINE_string('X', 'data/tfrecords/x_hazed.tfrecords',
                       'X tfrecords file for training, default: data/tfrecords/x_hazed.tfrecords')
tf.flags.DEFINE_string('Y', 'data/tfrecords/y_hazed.tfrecords',
                       'Y tfrecords file for training, default: data/tfrecords/y_hazed.tfrecords')

...
tf.flags.DEFINE_string('X_input_dir', 'data/ximages_hazed/',
                       'X input directory, default: data/ximages_hazed/')
tf.flags.DEFINE_string('Y_input_dir', 'data/yimages_unhazed/',
                       'Y input directory, default: data/yimages_unhazed/')
tf.flags.DEFINE_string('X_output_file', 'data/tfrecords/x_hazed.tfrecords',
                       'X output tfrecords file, default: data/tfrecords/x_hazed.tfrecords')
tf.flags.DEFINE_string('Y_output_file', 'data/tfrecords/y_hazed.tfrecords',
                       'Y output tfrecords file, default: data/tfrecords/y_hazed.tfrecords')
